            ...
            <div class="col-12">
                <div class="card" style="padding: 20px;">
                    <div class="card-header">
                        <h3 class="card-title">Tải lên danh sách số điện thoại</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive p-0">
                        <form class="form" action="{{ route('admin.import.uid') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="phoneList">Chọn tệp UID (.txt)</label>
                                <input id="phoneList" type="file" class="form-control" name="UIDList">
                            </div>

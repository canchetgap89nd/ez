	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="card card-primary">
			    ...
			    <!-- /.card-header -->
			    <!-- form start -->
			    <form role="form" action="{{ route('blog.update.category', $cate->id) }}" method="POST">
			    	{{csrf_field()}}
			        <div class="card-body">
			        	<input type="hidden" name="id" value="{{ $cate->id }}">
			        	<div class="form-group">
		                    <label for="nameCate">Tên danh mục</label>
		                    <input type="text" class="form-control" id="nameCate" name="cate_name" value="{{ $cate->cate_name }}" placeholder="Nhập tên danh mục ...">
	                  	</div>
			            <div class="form-group">
			                ...
			                <div class="input-group mb-3">
							    ...
							    <input id="slugCate" value="{{ $cate->slug()->first()->slug }}" name="cate_slug" type="text" class="form-control" placeholder="Đường dẫn tĩnh">
							</div>
			            </div>
			            <div class="form-group">
			            ...
			            <div class="form-group">
			                ...
			                <textarea id="Catedesc" name="cate_desc" class="form-control" placeholder="Nhập vào mô tả ...">{{ $cate->cate_desc }}</textarea>
			            </div>
			            <div class="form-group">
			                <label for="cate_keyword">Từ khóa</label>
			                <textarea id="cate_keyword" name="cate_keyword" class="form-control" placeholder="Nhập vào các keyword của danh mục cách nhau bởi dấu phẩy">{{ $cate->cate_keyword }}</textarea>
			            </div>
			            <div class="form-group">
	                  	...
	                  	<div class="form-group">
		                    ...
		                    <input type="text" class="form-control" value="{{ $cate->cate_order }}" id="cateOrder" name="cate_order" placeholder="Nhập số thứ tự ưu tiên hiển thị ...">
	                  	</div>
			        </div>
			        <!-- /.card-body -->

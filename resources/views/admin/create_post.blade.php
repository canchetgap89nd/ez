...
<section class="content">
	...
	<form id="formPostInfo" action="{{ route('blog.create.post') }}" method="post">
		{{ csrf_field() }}
	                ...
	                <div class="card-body">
						<div class="mb-3">
							<div class="form-group has-error">
							    ...
							    <input type="text" name="postTitle" class="form-control" onblur="generateSlug()" id="titlePost" placeholder="Nhập tiêu đề ..." value="{{ old('postTitle') }}">
							</div>
						</div>
						<div class="mb-3">
							<div class="input-group mb-3">
							    <div class="input-group-prepend">
							        <span class="input-group-text">https://chotsale.com.vn/blog/</span>
							    </div>
							    <input type="text" id="slugCate" name="postSlug" class="form-control" placeholder="Đường dẫn tĩnh" value="{{ old('postSlug') }}">
							</div>
						</div>
						<div class="mb-3">
							<div class="form-group has-error">
							    ...
							    <textarea rows="2" class="form-control" name="postDesc" placeholder="Nhập vào mô tả ngắn ...">{{ old('postDesc') }}</textarea>
							</div>
						</div>
						<div class="mb-3">
							<div class="form-group has-error">
							    ...
							    <textarea rows="2" class="form-control" id="post_keyword" name="post_keyword" placeholder="Nhập vào keyword của bài viết cách nhau bởi dấu phẩy">{{ old('post_keyword') }}</textarea>
							</div>
						</div>
	                    <div class="mb-3">
	                    ...
	                    <div class="mb-3">
							<div class="form-group">
			              		...
			              		<div class="text-center boxImgShow">
									<img id="imagePreview" src="{{ old('postThumb') ? old('postThumb') : asset('images/no-image.png') }}" alt="Chọn ảnh đại diện" />
			              		</div>
			              		<div class="text-left">
			              			<a href="{{ asset('plugins/tinymce/filemanager/dialog.php?type=1&field_id=thumb_article') }}" class="btn_add_pic">Thêm ảnh</a>
			              		</div>
			              		<input type="hidden" value="{{ old('postThumb') }}" name="postThumb" id="thumb_article">
			              	</div>
						</div>
						<div class="mb-3">
							<div class="form-group">
								...
								<div class="input-group">
				                  	<input type="text" class="form-control" value="{{ old('postSchedule') ? date('d/m/Y H:i:s', strtotime(old('postSchedule'))) : date('d/m/Y H:i:s', old('postSchedule', time())) }}" id="reservation">
				                  	<div class="input-group-append">
				                    	<span class="input-group-text"><i class="fa fa-calendar"></i></span>
				                  	</div>
				                  	<input type="hidden" value="{{ old('postSchedule') }}" name="postSchedule" id="timeSchedule">
				                </div>
							</div>
						</div>
						<div class="mb-3">
							<div class="form-group">
								<button type="button" onclick="savePost(1)" class="btn btn-primary">Xác nhận</button>
								<button type="button" onclick="savePost(2)" class="btn btn-default">Lưu nháp</button>
							</div>
						</div>
	                </div>
	            </div>

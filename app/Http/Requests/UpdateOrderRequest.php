...
class UpdateOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'infoOrder.phone_receive' => ['regex:/^(01[2689]|09)[0-9]{8}$/', 'required'],
            ...
            'infoOrder.province_id' => 'required|numeric',
            'infoOrder.district_id' => 'required|numeric',
            'infoOrder.ward_id' => 'required|numeric',
    ...
    {
        return [
            'infoOrder.phone_receive.required' => 'Vui lòng nhập số điện thoại người nhận',
            ...
            'infoOrder.province_id.required' => 'Vui lòng thêm địa chỉ người nhận',
            'infoOrder.district_id.required' => 'Vui lòng thêm địa chỉ người nhận',
            'infoOrder.ward_id.required' => 'Vui lòng thêm địa chỉ người nhận',
